...
interface WazuhLogoProps {
  className?: string;
  width?: number;
  height?: number;
}

export function WazuhLogo({ className = 'h-5 w-auto', width = 100, height = 24 }: WazuhLogoProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 305 72.7"
      width={width}
      height={height}
      fill="currentColor"
    ...
    >
      <g>
        ...
        <circle cx="296" cy="59.2" r="7.5" fill="#007AFF" />
      </g>
    </svg>
  );
}
